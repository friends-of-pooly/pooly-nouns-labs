...
const Main = (props: IMainProps) => (
  <div className="w-full bg-white p-0 px-1 text-gray-700 antialiased dark:bg-gray-700 dark:text-white">
    ...
    <div className="min-h-vh mx-auto h-10 w-full dark:bg-gray-700 dark:bg-indigo-800 dark:text-white dark:text-white">
      <div className="flex items-center justify-between border-b border-gray-300 px-8 py-4 dark:border-neutral-500 dark:bg-indigo-900 dark:text-white">
      ...
      <div className="border-t border-gray-300 bg-white py-8 text-center text-sm dark:border-neutral-500 dark:bg-indigo-800 dark:text-white">
